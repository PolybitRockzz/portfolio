...
const ProfileCard = () => {
  return (
    <div className="bg-neutral-950 text-white p-8 rounded-xl shadow-md max-w-2xl mx-auto my-5 border-2 border-neutral-800">
      <h2 className="text-4xl font-bold">Swastik Biswas</h2>      <p className="text-neutral-400 flex items-center gap-2">        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 15" fill="none" className="w-4 h-4">
        ...
        <span className="flex items-center gap-1">
          Kolkata, WB <Flag code="IN" className="w-4 h-3" /> | Wilmington, DE <Flag code="US" className="w-4 h-3" />
        </span>
      </p>
